...
This repository is past the constitution stage and into architecture: policies, Cursor rules, and v0.1 design docs exist; application packages are not scaffolded yet.
...
- [Architecture](docs/architecture/README.md) and [security design](docs/security/README.md)
- [Architecture decision records](docs/adr/README.md) (Proposed)
