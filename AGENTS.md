...
- Parsed-revision rows can now be inserted. No Prisma schema change. No adapter, object storage, provider retrieval, synchronization, matching, or Finding path is included. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Session 11 remains zero-Finding.
