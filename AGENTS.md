...
- ADR 0026 (Finding evidence and lifecycle) remains future. Do not claim that ADR exists.
...
- Finding writes remain blocked until OSV acquisition, at least one reviewed registry entry, deterministic evaluation, ADR 0026, explicit authorization, and tenant-isolation proof all exist.
