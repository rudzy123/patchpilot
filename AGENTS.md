...
### Known Session 9 gaps (after Batch 1B)
...
- No measured OSV archive or KEV body sizes. Implementation remains blocked on a later archive assessment.
- No Session 9 configuration, contracts, Prisma migration, provider HTTP, snapshot object-key layout, parser, worker, or API.
