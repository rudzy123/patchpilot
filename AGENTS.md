...
### Known Session 9 gaps (after Batch 2C)
...
- No Session 9 contracts, Prisma migration, provider HTTP, snapshot object-key layout, parser, worker, API, or ZIP dependency.
