...
Last verified checkpoint: Session 13 Batch 3D-E-R (adversarial review and hardening of protected listing-evidence encryption policy; no encryption execution; Prisma unchanged; schema design now permitted; Batch 4-P blocked).
Current session: Session 13.
Current checkpoint: Session 13 Batch 3D-E-R independently reviewed and hardened the uncommitted Batch 3D-E encryption policy (`osv_protected_listing_evidence_encryption_policy_v1`) in `@patchpilot/vulnerability-intelligence` (`src/osv/canary-listing-observation-evidence-encryption/`). Session 13 Batch 3D-P-R remains the authoritative protected-evidence policy. Batch 3C-R remains closed and committed as `8ce3bde`. Candidate-selection evidence remains unavailable. No protected observation store exists. Batch 3D-E-R did not contact a provider, execute another listing request, retrieve a body, modify Prisma, add a cryptography dependency, generate a key, encrypt provider data, or enable OSV. Selected capability remains Node.js 24 `node:crypto` AES-256-GCM as a closed platform requirement; implementation is deferred. Associated data is canonical length-prefixed UTF-8 that binds envelope version, policy IDs, evidence-set, observation, listing execution, provider-contact authorization, request, run, provider, prefix, generation, protocol, registry, version-set fingerprint, declared size, and source-family classification. AEAD uses those encoded bytes, not a SHA-256 digest. Opaque key aliases are `osv.listing.evidence.k` tokens and cannot be URLs, hostnames, or KMS endpoints. Only `current` encrypts; `retired` neither encrypts nor decrypts; destroyed keys cannot regain authority. Rotation verifies the new envelope before finalize and retains the prior readable copy. Per-set erasure remains Model B envelope redaction; purge evidence is authoritative after backup restore. Production composition does not import the policy. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Acquisition halt remains engaged. Session 13 Batch 3D-S protected listing-evidence persistence schema is next. Session 13 Batch 4-P remains blocked.
Current branch: `feat/osv-provider-canary`.

PatchPilot currently provides authentication, organization selection, asset inventory, SBOM upload and ingestion, local graph persistence, local CISA KEV synchronization, sanitized provider status, canonical CVE identity, a disabled synthetically verified OSV acquisition foundation, an uncomposed, adversarially reviewed Session 12 Batch 1 GCS listing-page HTTPS executor, Session 12 Batch 3 framework-independent listing pagination and two-pass inventory convergence contracts, an explicitly invoked Session 12 Batch 4 in-memory pagination and convergence service, the Session 12 Batch 4-R adversarial review of that service, Session 12 Batch 5 framework-independent durable synchronization job, lease, retry, parser-capacity, halt, cancellation, and operational-event contracts, Session 12 Batch 6 schema-only OSV runtime coordination persistence, Session 12 Batch 7 uncomposed PostgreSQL runtime-coordination adapters, the Session 12 Batch 7-R adversarial review of those adapters, Session 12 Batch 8 disabled runtime composition (`createOsvDisabledRuntimeSynchronization`), Session 12 Batch 9 typed acquisition halt and bounded operational observability, the Session 12 Batch 10 runtime-enablement foundation closure review, Session 13 Batch 2E-R adversarially reviewed uncomposed canary lease-heartbeat and monotonic-deadline controllers, Session 13 Batch 2F uncomposed executable canary preflight, Session 13 Batch 2F-R adversarial review of that preflight, Session 13 Batch 2-R combined operational-controls review, Session 13 Batch 3A uncomposed listing-only execution bridge against a scripted provider port (`createOsvCanaryListingOnlyExecutionBridge`), the Session 13 Batch 3A-R adversarial review of that bridge, Session 13 Batch 3B uncomposed listing-only provider-contact authorization evaluation (`createOsvListingProviderContactAuthorizationService`), Session 13 Batch 3B-A uncomposed listing-only provider-contact authorization PostgreSQL adapters (`createOsvListingProviderContactAuthorizationPersistence`), adversarially reviewed in Session 13 Batch 3B-A-R, Session 13 Batch 3B-R combined provider-contact authorization review, Session 13 Batch 3C-Auth uncomposed listing-canary execution-authorization (`createOsvListingCanaryExecutionAuthorizationService`), adversarially reviewed and hardened in Session 13 Batch 3C-Auth-R, and Session 13 Batch 3C uncomposed operator-controlled bounded listing canary (`createOsvBoundedListingCanaryService`) that executed exactly one real GCS listing request. Session 13 Batch 3C-R independently reviewed that listing-canary evidence: one request, no retry, no pagination, no body retrieval, halt restored, lease released, and candidate-selection evidence unavailable. Session 13 Batch 3D-P defines uncomposed protected listing-observation evidence policy (`osv_protected_listing_observation_evidence_policy_v1`) without contacting a provider or retaining real observation metadata. Session 13 Batch 3D-P-R independently reviewed and hardened that policy: public bare object-key digests are omitted, duplicate-ambiguous sets cannot become candidate ready, and schema work waited on encryption-policy adversarial review. Session 13 Batch 3D-E defines uncomposed encryption, key-management, envelope, associated-data, rotation, and erasure policy without executing encryption or modifying Prisma. Session 13 Batch 3D-E-R independently reviewed and hardened that encryption policy: associated data binds envelope version, declared size, and source-family classification; unknown envelope versions fail closed; opaque key aliases cannot be endpoints; rotation verifies before finalize; schema design may proceed. The pagination service, Batch 5 contracts, Batch 6 tables, Batch 7 adapters, Batch 8 composition, Batch 9 halt/observability controls, Batch 2E controllers, Batch 2F preflight, the one-shot command, the Batch 3A execution bridge, the Batch 3B provider-contact authorization service, the Batch 3B-P provider-contact authorization tables, the Batch 3B-A persistence factory, the Batch 3C-Auth execution-authorization service, the Batch 3C bounded listing-canary service, the Batch 3D-P evidence contracts, and the Batch 3D-E encryption contracts remain production-unreachable. The operator script is not registered in worker, API, or application startup. General OSV runtime remains disabled. Session 13 Batch 4-P is blocked by unavailable candidate-selection evidence.
...
- Session 13 Batch 3C-R independently reviewed that committed listing canary. One provider attempt, zero retries, zero redirects followed, zero pagination follow-ups, zero body requests, halt restored, controllers stopped, lease released, active pointer unchanged, and no storage, parser, activation, matching, tenant, or Finding work. Per-observation object identity, generation, declared size, and source-family classification were not retained. Classification: `candidate_selection_evidence_unavailable_new_provider_authorization_required`. That classification does not authorize another request. Session 13 Batch 4-P is blocked.
- Session 13 Batch 3D-P defines framework-independent protected listing-observation evidence contracts (`src/osv/canary-listing-observation-evidence/`). Purpose is validated listing metadata for later deterministic candidate evaluation and review. It is not body authority, a catalog, inventory completeness, pagination permission, or permission to contact the provider again. Maximum protected observations 1000. Maximum object-key UTF-8 bytes 512. Maximum total evidence metadata bytes 1,298,432. Protected object identity is WeakMap-backed. Session 13 Batch 3D-P-R later omitted the public bare object-key digest. Exact positive decimal generation is preserved as a string. Declared size and listing-parser source-family classification are retained. Exact duplicates are classified, not silently dropped. Immutable conflicts fail closed. Persistence decision: durable protected persistence required; Prisma unchanged. Retention policy `osv_protected_listing_observation_evidence_retention_v1` (maximum 7,776,000 seconds overdue marker, no automatic delete). Future listing-evidence acquisition authorization is `osv_listing_observation_evidence_acquisition_authorization_v1` and cannot reuse Batch 3C authority. Tests use synthetic observation metadata only. No provider contact. Production composition does not import the module. Session 13 Batch 3D-P-R independently reviewed this policy.
- Session 13 Batch 3D-E defines framework-independent protected listing-evidence encryption policy (`src/osv/canary-listing-observation-evidence-encryption/`). Policy identifier `osv_protected_listing_evidence_encryption_policy_v1`. Envelope `osv_protected_listing_evidence_ciphertext_envelope_v1`. Associated-data policy `osv_protected_listing_evidence_associated_data_v1`. Selected capability is Node.js 24 `node:crypto` AES-256-GCM; no encryption executes in this batch and no cryptography dependency is added. Public contracts omit plaintext, ciphertext, nonce, tag, and raw key identifiers. Key material is instance-owned and operator-provided at runtime; process environment remains confined to `packages/config`; no environment variable is added. Missing, malformed, and wrong keys fail closed. Retired keys cannot encrypt. Destroyed keys cannot decrypt. Rotation is separately authorized re-encryption that preserves associated data and must not destroy the only readable envelope. Per-set unrecoverability is Model B envelope redaction; destroying the instance key is forbidden as per-set purge. Ciphertext may appear in backups; raw keys must not. Tests use synthetic secret markers only. No provider contact. Production composition does not import the module. Session 13 Batch 4-P remains blocked.
- Session 13 Batch 3D-E-R independently reviewed and hardened that uncommitted encryption policy. Concrete corrections: associated data binds envelope version, declared size, and source-family classification; AEAD uses canonical encoded bytes rather than a digest; unknown envelope versions and caller-selected algorithms fail closed; all-zero nonces are rejected; opaque key aliases cannot resemble hostnames or KMS URIs; incomplete key state cannot report persistence-ready; decryption requires exact evidence-set, observation, request, run, and purpose binding; rotation retains the prior readable envelope until the new envelope is verified; stale instances cannot encrypt with retired keys; purge evidence is authoritative after backup restore. Schema design may proceed. No plaintext protected-key column. No encryption execution. No Prisma, migration, dependency, or lockfile change. Next checkpoint is Session 13 Batch 3D-S.
...
- Durable OSV job registration, retry execution, scheduler wiring, catalog activation, matching, and Finding writes. Token-cycle detection and A/B convergence execute only inside the uncomposed Batch 4 in-memory service, the disabled Batch 8 composition, and the uncomposed Batch 3A scripted listing-only bridge. Session 13 Batch 3C executed one operator-controlled listing-only real-provider canary; Session 13 Batch 3C-R independently reviewed that evidence and classified candidate-selection metadata as unavailable. Session 13 Batch 3D-P defines the protected observation evidence required for a future separately authorized listing; it does not retain real observations, issue a new authorization, or select a body candidate. Session 13 Batch 3D-E defines the encryption policy required before schema; it does not encrypt, persist, or contact a provider. Session 13 Batch 3D-E-R independently reviewed and hardened that policy; schema design may proceed without a plaintext protected-key column. Session 13 Batch 4-P is blocked. Production operator authentication, public CLI, legal issuance, body canary, catalog activation, matching, and Finding writes remain later gates.
...
- Session 13 Batch 3C implements uncomposed `createOsvBoundedListingCanaryService` and the nonpublic operator command `scripts/run-osv-listing-canary.mjs`. After synthetic rehearsal and explicit operator invocation, exactly one listing HTTPS request was sent to the committed GCS JSON Objects listing endpoint for `crates.io/`. Outcome `listing_canary_one_page_classified` with one request, one accepted page, 320143 bytes, 1000 observations, continuation token present and unused, retries 0, pagination 0, and body requests 0. Halt restoration `restored`. Deadline and heartbeat stopped. Guarded lease release `released`. Active pointer unchanged. Zero Finding operations. No provider response fixture was retained. Production composition does not construct the factory. The operator script is not registered in worker, API, or application startup. `INTELLIGENCE_OSV_ENABLED=true` remains rejected.
- Session 13 Batch 3C-R independently reviewed that committed listing canary. One provider attempt, zero retries, zero redirects followed, zero pagination follow-ups, zero body requests, halt restored, controllers stopped, lease released, and no storage, parser, activation, matching, tenant, or Finding work. Per-observation object identity, generation, declared size, and source-family classification were not retained. Classification: `candidate_selection_evidence_unavailable_new_provider_authorization_required`. That classification does not authorize another request. Session 13 Batch 4-P is blocked.
- Session 13 Batch 3D-P defines uncomposed protected listing-observation evidence policy (`osv_protected_listing_observation_evidence_policy_v1`) in `@patchpilot/vulnerability-intelligence`. Provider-free. Durable protected persistence is required; Prisma and migrations are unchanged. Raw response and continuation-token retention remain prohibited. Protected object identity is nonpublic. Exact generation is mandatory. Candidate evidence is not body authority. A new listing request requires new authorization and operator confirmation. Batch 3C authority cannot be reused. Tests use synthetic observation metadata only. No provider contact occurred. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Session 13 Batch 4-P remains blocked.
- Session 13 Batch 3D-P-R independently reviewed that uncommitted policy. Concrete corrections: public surfaces omit the bare SHA-256 of the raw provider object key; the production digest-override seam is absent; WeakMap destroy drops references and does not claim physical erasure; duplicate-ambiguous sets are not candidate ready; conflict and overflow reject the complete set; conflict cannot transition to review-accepted; capacity arithmetic is documented and consistent; generation remains the committed 1–20 ASCII-digit TEXT grammar; purge is a controlled redaction of one encrypted-envelope column plus an append-only purge row; plaintext protected-key columns are forbidden. Next checkpoint after Batch 3D-E is Session 13 Batch 3D-E-R. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Halt defaults true. Session 13 remains zero-Finding.
- Session 13 Batch 3D-E defines uncomposed protected listing-evidence encryption policy (`osv_protected_listing_evidence_encryption_policy_v1`) in `@patchpilot/vulnerability-intelligence`. Provider-free. Schema-free. Dependency-free. AES-256-GCM is the closed Node.js 24 platform capability requirement; no encryption executes. Associated data binds immutable evidence context. Key material is operator-provided later through `packages/config`. Purge remains controlled redaction. Batch 3D-S cannot create a plaintext protected-key column. Production composition does not import the module. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Session 13 Batch 4-P remains blocked.
- Session 13 Batch 3D-E-R independently reviewed and hardened that uncommitted encryption policy. Associated data binds envelope version, policy IDs, evidence-set, observation, listing execution, provider-contact authorization, request, run, provider, prefix, generation, protocol, registry, version-set fingerprint, declared size, and source-family classification. AEAD uses canonical encoded bytes, not a SHA-256 digest. Unknown envelope versions and caller-selected algorithms fail closed. All-zero nonces are rejected. Opaque key aliases are `osv.listing.evidence.k` tokens and cannot be URLs, hostnames, or KMS endpoints. Only `current` encrypts; `retired` neither encrypts nor decrypts; destroyed keys cannot regain authority. Decryption requires exact evidence-set, observation, request, run, and closed purpose. Rotation verifies the new envelope before finalize and retains the prior readable copy. Stale instances cannot encrypt with retired keys. Purge evidence is authoritative after backup restore. Schema design may proceed. No encryption execution. No Prisma, migration, dependency, or lockfile change. Production composition does not import the module. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Session 13 Batch 3D-S is next. Session 13 Batch 4-P remains blocked.
...
- Finding writes are not authorized in Session 12 or Session 13 Batch 3D-P. They remain blocked until an active authoritative catalog, package normalization, a reviewed ecosystem evaluator, a deterministic `affected` result, persisted immutable match evidence, [ADR 0026](docs/adr/0026-authoritative-match-evidence-and-finding-lifecycle.md) gates, tenant-isolation proof, and explicit Finding-write authorization are complete. Architectural gates are authoritative, not the assigned session number. The current roadmap places that work no earlier than Session 16.
...
- Automatic retries remain 0. Body retrieval, catalog activation, matching, and Finding writes remain unauthorized. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Session 13 remains zero-Finding. Session 13 Batch 3C-R independently reviewed this listing canary. Do not retry the real-provider request. Do not request a second page.

### Session 13 Batch 3C-R (listing-canary evidence review)

These are deliberate. Do not silently close one inside an unrelated change, and do not write documentation that assumes any of them exists:

- Session 13 Batch 3C-R independently reviewed the committed Batch 3C listing canary using production code, bounded machine evidence, tests, counters, Accepted ADRs, and runbooks. Tests are local and synthetic. The real operator command was not rerun. No DNS, TLS, HTTP, listing, pagination, or body retrieval occurred during this review.
- Verified from committed code and recorded evidence: exactly one real-provider listing HTTPS request; retries 0; redirects followed 0; pagination follow-ups 0; second prefix 0; body requests 0; request destination is the committed GCS JSON Objects listing host and path for prefix `crates.io/`; response handling remained inside 1,048,576 bytes and 1000 observations; continuation-token presence was recorded and the raw token was not retained, printed, or followed; halt restored; deadline stopped; heartbeat stopped; lease released; active pointer unchanged; activation history unchanged; storage writes 0; parser executions 0; reconciliation 0; activation 0; normalization 0; matching 0; tenant operations 0; Finding writes 0.
- Existing bounded evidence is sufficient to close Batch 3C as a listing-only protocol canary.
- Per-observation metadata required for future deterministic body-candidate selection is **unavailable**. The listing translator retains aggregate counts only. The operator composition uses an ephemeral database that is dropped after the command. No protected internal observation store exists. Classification: `candidate_selection_evidence_unavailable_new_provider_authorization_required`. That classification does not authorize another request.
- Session 13 Batch 4-P is blocked. Do not implement candidate-selection logic in this batch. Do not fabricate a synthetic object candidate and present it as provider evidence.
- Production composition still does not construct the factory. The operator script remains unregistered. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Halt defaults true. Session 13 remains zero-Finding.

### Session 13 Batch 3D-P (protected listing-observation evidence policy)

These are deliberate. Do not silently close one inside an unrelated change, and do not write documentation that assumes any of them exists:

- Session 13 Batch 3D-P defines framework-independent protected listing-observation evidence contracts in `@patchpilot/vulnerability-intelligence` (`src/osv/canary-listing-observation-evidence/`). Policy identifier `osv_protected_listing_observation_evidence_policy_v1`. Schema `osv_protected_listing_observation_evidence_v1`. Ownership `instance_owned_non_tenant`. Status `framework_independent_contracts_provider_free_uncomposed`. Implementation `in_memory_policy_contracts_no_persistence_adapter`. Production registration `absent`. Next checkpoint relative to this Batch 3D-P checkpoint was Session 13 Batch 3D-P-R.
- Session 13 Batch 3C-R remains closed and committed. Aggregate listing evidence closed Batch 3C. Candidate-selection evidence remains unavailable. No protected observation store exists. Batch 3D-P does not mutate Batch 3C evidence, reuse Batch 3C authorization, execute another listing request, retrieve a body, or enable OSV.
- Purpose is validated listing metadata retained solely to support deterministic canary candidate evaluation and later evidence review. Prohibited purposes include body-retrieval authorization, provider catalog, complete inventory, active catalog, tenant vulnerability evidence, package match evidence, Finding evidence, pagination permission, repeat provider contact, and reuse of Batch 3C authorization or execution permit.
- Minimum protected fields: evidence schema version; listing execution, provider-contact authorization, request, and run identities; provider; approved prefix; listing policy; budget profile; runtime-version-set fingerprint; observation ordinal; protected validated provider object identity; exact positive decimal generation; declared byte count; source-family classification; listing observation identity; listing protocol; source-license registry version; captured-at (null until persistence stamps database time); evidence state; retention-policy ID; candidate-selection eligibility; immutable-conflict classification. Raw response body, decoded listing JSON, continuation token, response headers, full request URL, query string, provider error body, ETag, MD5, provider body, parsed advisory, storage locator, tenant identity, package identity, and Finding identity are forbidden.
- Protected object identity is WeakMap-backed. Session 13 Batch 3D-P originally exposed a public object-key digest; Session 13 Batch 3D-P-R removed that digest because it is a confirmation oracle. Public serialization, inspect, logs, events, metrics, traces, and errors omit the raw key and the bare object-key digest. A digest is not sufficient for later generation-bound retrieval. Encryption at rest is an architectural requirement and is a schema-blocking prerequisite after Batch 3D-P-R. This batch adds no cryptographic scheme. Key readers are not package public exports.
- Generation is an exact positive decimal string `/^[1-9][0-9]{0,19}$/` with no Number conversion, floating point, latest fallback, ETag/MD5/timestamp/metageneration substitution, or cross-object reuse. Candidate selection without exact generation is prohibited.
- Declared size is the exact validated non-negative listing byte count, not retrieved size. Source-family classification is the listing-parser result (`parseOsvObjectKey` plus `classifyOsvPreRetrieval`); unknown or ambiguous family is ineligible. No confidence enum exists.
- Capacity is closed and not caller-overridable: 1000 records; 512 object-key UTF-8 bytes per record; 512,000 total protected key bytes; 4096 canonical bytes per record; 4,194,304 canonicalization workspace bytes; 786,432 public metadata bytes; 1,298,432 total evidence metadata bytes; 1001 transaction rows; 16 events; pending writes 0; concurrency 1. Overflow rejects the entire evidence set.
- Canonical identity is length-prefixed UTF-8 SHA-256 over provider, object identity, generation, prefix, declared size, source family, listing protocol, and listing-execution binding. Set digest is order-independent. Exact duplicates are classified and counted, not silently dropped. Immutable disagreement and digest collision fail closed. Distinct generations of the same object are distinct evidence. Last-write-wins is forbidden.
- One immutable evidence set binds one listing execution, one provider-contact authorization, one request, one run, one provider, one prefix, page 1, one policy and budget, and one runtime version set. Summaries include accepted, protected, rejected, duplicate, and conflict counts plus a canonical evidence-set digest. The set does not claim prefix completeness, inventory completeness, body eligibility, or activation readiness.
- Persistence decision: Option A, `durable_protected_persistence_required`. Rationale: the Batch 3C-R ephemeral database discarded candidate metadata, and independent review plus later authorization issuance cannot rely on one operator process. Future tables (`osv_listing_observation_evidence_set`, `osv_listing_observation_evidence`, `osv_listing_observation_evidence_purge`) are named only. Prisma, migrations, and adapters are not added in this batch. Rows are global, instance-owned, append-only, DELETE-forbidden, and tenant/Finding-free.
- Retention policy `osv_protected_listing_observation_evidence_retention_v1`. Minimum retention lasts until independent review is recorded and dependent authorizations are terminal. Maximum 7,776,000 seconds is an overdue review marker, not automatic delete. No TTL worker, cleanup loop, or cascade delete. Cleanup requires review, dependent-authorization closure, no legal hold, and a distinct cleanup grant, then protected-identity erasure plus an append-only purge row.
- Candidate-selection readiness requires a complete page, reconciled counts, no overflow, no immutable conflict, no duplicate ambiguity, exact bindings, protected identity, exact generation, declared size, source family, retention authority, and later review. Even a complete synthetic set has `candidateSelectionAuthorized=false`, `bodyRetrievalAuthorized=false`, and `batch4pPermitted=false`.
- Future listing-evidence acquisition authorization `osv_listing_observation_evidence_acquisition_authorization_v1` authorizes one listing request for one approved prefix with protected observation retention. It does not authorize pagination, a second page, body retrieval, another prefix, retry, activation, matching, or Finding creation. Batch 3C listing, provider-contact, confirmation, and permit authority are consumed and unreusable. A new request requires new canary authorization, new provider-contact authorization, new operator confirmation, new lease ownership, new heartbeat and deadline, a new one-use permit, and mandatory evidence review.
- Tests use synthetic observation metadata only. No real provider observation is stored. Production composition does not import the factory. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Halt defaults true. Session 13 remains zero-Finding.

### Session 13 Batch 3D-P-R (protected listing-evidence policy adversarial review)

These are deliberate. Do not silently close one inside an unrelated change, and do not write documentation that assumes any of them exists:

- Session 13 Batch 3D-P-R independently reviewed the uncommitted Batch 3D-P policy with synthetic observation metadata only. It did not contact `storage.googleapis.com` or `osv.dev`, rerun the listing canary, retrieve a body, or modify Prisma.
- Concrete corrections: public results, JSON, inspect, events, and logs omit both the raw provider object key and the bare SHA-256 of that key. Domain-separated canonical observation-set identifiers remain Internal/public summaries and are not retrieval values. The production constructor has no digest-override seam. Key readers and identity constructors are not package public exports.
- WeakMap destroy and garbage collection drop process-local references. JavaScript cannot guarantee physical memory erasure. Durable protection is a later encrypted envelope, not this WeakMap.
- Duplicate observations are classified and counted. One protected row may be retained, but the set state is `duplicate_ambiguous` and `candidateSelectionReadiness` is `ineligible_duplicate_ambiguity`. Conflicts, overflow, and malformed input reject the complete set. Conflict cannot transition to review-accepted.
- In-memory construction emits `constructed` or `duplicate_ambiguous` only. `review_pending` is persistence-time. Review acceptance is not available in this batch.
- Capacity constants have accepted rationales. `512000 = 1000 × 512`, `1298432 = 786432 + 512000`, `1001 = 1000 + 1`, and `7776000 = 90 × 24 × 60 × 60`. Units are UTF-8 bytes except records, rows, events, and seconds. One-over rejects the complete set.
- Generation remains the committed 1–20 ASCII-digit positive decimal string stored later as TEXT, not PostgreSQL BIGINT. Declared size remains distinct from retrieved size and is canonicalized as big-endian uint64.
- Durable persistence remains required. Session 13 Batch 3D-E now defines the encryption-policy contracts. Schema work cannot begin until Batch 3D-E-R accepts that policy. Plaintext, reversible encoding, base64-as-encryption, static keys, and keys stored beside ciphertext remain forbidden.
- Purge model is a controlled redaction transition: one authorized encrypted-envelope column may be overwritten or nulled; immutable evidence metadata remains; an append-only purge row is required; DELETE remains forbidden.
- Batch 3C authority remains consumed and unreusable. Batch 4-P remains blocked. Production composition does not import the module. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Halt defaults true. Session 13 remains zero-Finding. Next checkpoint after Batch 3D-E is Session 13 Batch 3D-E-R.

### Session 13 Batch 3D-E (protected listing-evidence encryption policy)

These are deliberate. Do not silently close one inside an unrelated change, and do not write documentation that assumes any of them exists:

- Session 13 Batch 3D-E defines framework-independent protected listing-evidence encryption policy in `@patchpilot/vulnerability-intelligence` (`src/osv/canary-listing-observation-evidence-encryption/`). Policy identifier `osv_protected_listing_evidence_encryption_policy_v1`. Envelope `osv_protected_listing_evidence_ciphertext_envelope_v1`. Associated-data policy `osv_protected_listing_evidence_associated_data_v1`. Status `framework_independent_contracts_provider_free_uncomposed`. Implementation `policy_contracts_only_encryption_execution_absent`. Production registration `absent`. Next checkpoint is Session 13 Batch 3D-E-R.
- Batch 3D-P / 3D-P-R remain the authoritative protected-evidence policy. Batch 3D-E does not mutate Batch 3C evidence, reuse Batch 3C authorization, execute another listing request, retrieve a body, encrypt real values, or enable OSV.
- Exact protected field requiring encryption is the validated provider object identity. Plaintext provider object identities are prohibited at rest. Plaintext may exist only inside a narrow authorized process-local WeakMap boundary. Dropping references is not physical memory erasure.
- Selected cryptographic capability is Node.js 24 `node:crypto` AES-256-GCM (32-byte key, 12-byte nonce, 16-byte tag). Custom constructions, unauthenticated modes, caller-selected ciphers or nonces, silent downgrade, and algorithm negotiation from persisted data are forbidden. Implementation is deferred. No cryptography dependency is added.
- Associated data is canonical length-prefixed UTF-8 over immutable evidence context (envelope policy, evidence schema, evidence-set ID, observation ID, listing execution, provider-contact authorization, request, run, provider, prefix, generation, listing protocol, source-license registry, runtime-version-set fingerprint). Ciphertext transplanted across records, runs, providers, prefixes, or generations fails authentication by policy.
- Key owner is an instance-level deployment authority, not tenants, canary operators, or API callers. Keys enter only through a future `packages/config` runtime secret boundary. No default key. No hardcoded key. Missing, malformed, and wrong keys fail closed. Retired keys cannot encrypt. Destroyed keys cannot decrypt. Opaque key references cannot be cloud URLs, account IDs, filesystem paths, or metric labels. Persisted data cannot select an arbitrary KMS endpoint.
- Rotation is separately authorized re-encryption under the current instance key while preserving associated data. Rotation failure must not destroy the only readable envelope. There is no automatic unbounded rotation loop and no plaintext fallback.
- Purge remains Batch 3D-P Model B controlled redaction. Per-set cryptographic erasure is authorized envelope redaction plus an append-only purge row. Destroying the shared instance key is forbidden as per-set purge because it would render unrelated remaining envelopes unrecoverable. Ciphertext in backups remains until those backups and required keys are independently destroyed.
- Readiness is a pure evaluation and never encrypts. Generic `ready: true` is insufficient. Even a current key does not make encryption execution available in this batch. Persistence remains unavailable. Provider contact remains unauthorized.
- Tests use synthetic secret markers only. Production composition does not import the module. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Halt defaults true. Session 13 remains zero-Finding. Session 13 Batch 3D-S remains blocked until Batch 3D-E-R. Session 13 Batch 4-P remains blocked.

### Session 13 Batch 3D-E-R (protected listing-evidence encryption adversarial review)

These are deliberate. Do not silently close one inside an unrelated change, and do not write documentation that assumes any of them exists:

- Session 13 Batch 3D-E-R independently reviewed the uncommitted Batch 3D-E encryption policy with synthetic secret markers only. It did not contact `storage.googleapis.com` or `osv.dev`, rerun the listing canary, retrieve a body, generate a production key, encrypt provider data, persist ciphertext, or modify Prisma.
- Concrete corrections: associated data binds envelope version, associated-data policy ID, declared size, and source-family classification in addition to the committed evidence identities; AEAD associated data is the canonical length-prefixed UTF-8 encoding, not a SHA-256 digest of that encoding; envelope admission requires the exact closed schema version, cryptographic policy ID, algorithm ID, and associated-data policy ID, so unknown versions and caller-selected algorithms fail closed; all-zero nonces are rejected; opaque key aliases match `^osv\.listing\.evidence\.k[a-z0-9]{1,24}$` and cannot be URLs, hostnames, filesystem paths, or KMS endpoints; incomplete `configured` key state cannot report persistence-ready; decryption requires evidence-set, observation, request, run, and a closed purpose; rotation evaluates verify-before-finalize and cannot discard the only readable envelope; stale instances cannot encrypt with retired keys; purge evidence is authoritative after backup restore even if keys remain available.
- Selected cryptographic capability remains Node.js 24 `node:crypto` AES-256-GCM as a closed platform requirement. Implementation is deferred. No cryptography dependency is added. Production nonce generation remains a future CSPRNG capability; deterministic test nonce seams are not public exports.
- Key granularity remains instance-level AES-256. Per-set unrecoverability remains Batch 3D-P Model B controlled redaction of one envelope column plus an append-only purge row. Destroying the shared instance key is forbidden as per-set purge.
- Schema design may proceed around the closed envelope layout (`nonce_12 || ciphertext || tag_16` BYTEA, no plaintext protected-key column). Encryption execution, key-provider construction, persistence adapters, and production composition remain absent.
- Production composition does not import the module. `INTELLIGENCE_OSV_ENABLED=true` remains rejected. Halt defaults true. Session 13 remains zero-Finding. Next checkpoint is Session 13 Batch 3D-S protected listing-evidence persistence schema. Session 13 Batch 4-P remains blocked.
