...
export const OUTBOX_RELAY_BATCH_LIMIT = 50;
export const OUTBOX_RELAY_LEASE_MS = 30_000;
export const OUTBOX_RELAY_MAX_ATTEMPTS = 5;
export const OUTBOX_RELAY_RETRY_BASE_MS = 5_000;
export const OUTBOX_RELAY_RETRY_CAP_MS = 900_000;
export const OUTBOX_RELAY_POLL_INTERVAL_MS = 1_000;
export const OUTBOX_QUEUE_NAME = 'patchpilot' as const;
