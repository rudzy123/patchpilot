...
export {
  ...
  type BoundedKevSnapshotCollectInput,
...
export {
  ...
  type CatalogRegressionDecision,
  type ContentHashNotModifiedDecision,
  type IntelligenceRetryWaitBounds,
} from './sync-decisions.js';
export {
  parsedEntryMatchesStaged,
  verifyDenseStagedPrefix,
  type StagedPrefixVerification,
} from './staging-resume.js';
export {
  attemptsRemain,
  mapIntelligenceSyncFailure,
  type IntelligenceSyncFailureAction,
  type IntelligenceSyncFailureLayer,
} from './sync-failures.js';
export {
...
export type {
  ...
  IntelligenceKevParserFailure,
  IntelligenceKevParserLimits,
  IntelligenceKevParserPort,
  IntelligenceKevParserSuccess,
  IntelligenceKevParserWarningSummary,
