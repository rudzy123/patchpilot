...
| `osv_canary_instance_operator_identity`, `osv_canary_authorization` (Session 13 Batch 2B; instance-owned, unused by production runtime) | tenant `outbox_event`, `background_job` (when org set), `idempotency_record` |
