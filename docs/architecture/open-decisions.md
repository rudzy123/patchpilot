...
| OSV kill-switch variable | `INTELLIGENCE_OSV_ACQUISITION_HALT` | Session 12 Batch 5 defines halt checkpoints and the future safe default **halted**. Variable not added. | Later runtime-composition batch. Missing/malformed → halted; enablement remains rejected and does not clear halt. |
