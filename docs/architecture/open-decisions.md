...
| OSV listing executor implementation | HTTPS listing adapter against ADR 0028 §1 | Session 12 Batch 1 implements `createOsvGcsListingHttpsAdapter`. Uncomposed and runtime-unreachable. | Current checkpoint is Session 12 Batch 2 adversarial review. Do not contact `storage.googleapis.com` from production composition. Pagination remains later Session 12 work. |
