...
| Source-license revalidation | Immutable `osv_source_license_registry_v1` with Batch 3A-P evidence; ADR 0028 pins revalidation points; ADR 0029 treats registry `approved` as insufficient for canary legal authorization | Awaiting canary (legal revalidation before any provider contact; listing permission is not body permission) |
