...
| [OSV first-provider canary procedures](osv-canary.md) | Session 13 Batch 2F-R reviewed preflight, halt, lease, heartbeat, deadline, egress, listing, cancellation, pointer, Finding, and review procedures (preflight exists and is production-unregistered; provider contact remains unauthorized) |
