...
| [OSV first-provider canary procedures](osv-canary.md) | Session 13 Batch 3B-R reviewed the complete listing-only provider-contact authorization chain (command, preflight, controllers, scripted bridge, authorization service, and persistence adapters remain production-unregistered; successful consumption does not authorize provider contact; next is Batch 3C-Auth) |
