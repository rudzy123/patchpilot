...
| [OSV first-provider canary procedures](osv-canary.md) | Session 13 Batch 3C-Auth-R independently reviewed uncomposed listing-canary execution authorization (command, preflight, controllers, scripted bridge, authorization service, persistence adapters, and execution-authorization remain production-unregistered; one private one-use permit does not contact a provider; next is Batch 3C) |
