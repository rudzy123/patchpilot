...
| [OSV first-provider canary procedures](osv-canary.md) | Session 13 Batch 3A-R reviewed the uncomposed scripted listing-only execution bridge (command, preflight, controllers, and bridge remain production-unregistered; provider contact remains unauthorized; Batch 3B is next) |
