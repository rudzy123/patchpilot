...
| [OSV first-provider canary procedures](osv-canary.md) | Session 13 Batch 2-R reviewed authorization preparation, preflight, halt, lease, heartbeat, deadline, egress, listing, cancellation, pointer, Finding, and review procedures (command and preflight exist and are production-unregistered; provider contact remains unauthorized; Batch 3A execution bridge is next) |
