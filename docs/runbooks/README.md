...
| [OSV first-provider canary procedures](osv-canary.md) | Session 13 Batch 3C executed one operator-controlled listing-only real-provider canary (command remains production-unregistered; halt restored; lease released; do not retry; Session 13 Batch 3C-R evidence review is mandatory) |
