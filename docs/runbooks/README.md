...
| [OSV first-provider canary procedures](osv-canary.md) | Session 13 Batch 3B-P-R froze listing-only provider-contact authorization schema only (command, preflight, controllers, scripted bridge, and authorization service remain production-unregistered; no issuance adapter; durable issuance before Batch 3C) |
